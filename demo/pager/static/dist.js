    ...
    return (
      React.createElement("div", {className: "book"}, 
        React.createElement("div", {className: "content"}, 
          React.createElement("p", null, "页面内容"), 
    ...
    var pages = this.state.pages.map(function (i) {
      if(this.state.curPage == i){
        return this.state.pages? (
          React.createElement(PagerBtn, {isCur: true, num: i, hasNum: this._turnTo})
        ) : null;
      }else{
        return this.state.pages? (
          React.createElement(PagerBtn, {isCur: false, num: i, hasNum: this._turnTo})
        ) : null;
      }
    }.bind(this));
    return (
      React.createElement("div", {className: "z_pager_container clearfix"}, 
        React.createElement("div", {className: "z_pager_head", onClick: this._toHead}, "首页"), 
        React.createElement("div", {className: "z_pager_prev", onClick: this._turnPrev}, "上一页"), 
          pages, 
        React.createElement("div", {className: "z_pager_next", onClick: this._turnNext}, "下一页"), 
        React.createElement("div", {className: "z_pager_last", onClick: this._toLast}, "尾页")
      )
    );
  }
});
