  ...
  render : function () {
    var pages = this.state.pages.map(function (i) {
      return this.state.pages? (
        React.createElement("div", {className: "z_pager_page"}, i)
      ) : null;
    }.bind(this));
    return (
      React.createElement("div", {className: "z_pager_container clearfix"}, 
        React.createElement("div", {className: "z_pager_first"}, "首页"), 
        React.createElement("div", {className: "z_pager_prev"}, "上一页"), 
          pages, 
        React.createElement("div", {className: "z_pager_next"}, "下一页"), 
        React.createElement("div", {className: "z_pager_last"}, "尾页")
      )
    );
  }
});
